...
| GIT_SYNC_HOOK_COMMAND_TIMEOUT   | `--sync-hook-command-timeout`        | the timeout for the sync hook command                                                                                                                                                                                                         | 30 (seconds)                    |
| GIT_SYNC_HOOK_COMMAND_BACKOFF   | `--sync-hook-command-backoff`        | the time to wait before retrying a failed sync hook command                                                                                                                                                                                   | 3 (seconds)                   |
